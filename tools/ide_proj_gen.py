...
le501x_keil_proj_gen('examples/peripheral/crypt/ecb_it_padding')
...
le501x_keil_proj_gen('examples/peripheral/i2c/ll_i2c_it')
...
le501x_keil_proj_gen('examples/peripheral/spi/ll_spi_it')
...
le501x_keil_proj_gen('examples/peripheral/ssi/ll_ssi_it')
...
le501x_keil_proj_gen('examples/peripheral/uart/ll_uart_it')
