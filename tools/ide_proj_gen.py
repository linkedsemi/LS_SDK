...
if __name__ == '__main__':
    ...
    le501x_proj_gen('examples/peripheral/i2c/i2c_master_it')
    le501x_proj_gen('examples/peripheral/i2c/i2c_master_it_mem_read_write')
    le501x_proj_gen('examples/peripheral/i2c/i2c_slave_it_mem_read_write')
    ...
    le501x_proj_gen('examples/peripheral/timer/Encode_TIM')
    ...
    le501x_proj_gen('examples/peripheral/trng')
    ...
    lm3050_proj_gen('examples/peripheral/i2c/i2c_master_it')
    lm3050_proj_gen('examples/peripheral/i2c/i2c_master_it_mem_read_write')
    lm3050_proj_gen('examples/peripheral/i2c/i2c_slave_it_mem_read_write')
    ...
    lm3050_proj_gen('examples/peripheral/timer/Encode_TIM')
