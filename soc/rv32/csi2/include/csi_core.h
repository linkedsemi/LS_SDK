...
__STATIC_INLINE const char* csi_get_cpu_name()
{
    ...
    return "c908i";
#elif CONFIG_CPU_XUANTIE_C908_V2
    return "c908_v2";
#elif CONFIG_CPU_XUANTIE_C908V_V2
    return "c908v_v2";
#elif CONFIG_CPU_XUANTIE_C908I_V2
    return "c908i_v2";
#elif CONFIG_CPU_XUANTIE_C908_CP_V2
    return "c908-cp_v2";
#elif CONFIG_CPU_XUANTIE_C908V_CP_V2
    return "c908v-cp_v2";
#elif CONFIG_CPU_XUANTIE_C908I_CP_V2
    return "c908i-cp_v2";
#elif CONFIG_CPU_XUANTIE_C908_CP_XT_V2
    return "c908-cp-xt_v2";
#elif CONFIG_CPU_XUANTIE_C908V_CP_XT_V2
    return "c908v-cp-xt_v2";
#elif CONFIG_CPU_XUANTIE_C908I_CP_XT_V2
    return "c908i-cp-xt_v2";
#elif CONFIG_CPU_XUANTIE_C908VK_CP_V2
    return "c908vk-cp_v2";
#elif CONFIG_CPU_XUANTIE_C908VK_CP_XT_V2
    return "c908vk-cp-xt_v2";
