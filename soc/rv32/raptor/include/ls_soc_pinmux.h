...
/**
  ...
  */
void pinmux_iis2_master_ck_init(uint16_t ck);

/**
  * @brief   Set pin mux function to iis2 master ws
  * @param   ws  Specific GPIO pin
  */
void pinmux_iis2_master_ws_init(uint16_t ws);
...
/**
  ...
  */
void pinmux_iis2_master_sd_init(uint16_t sd, uint8_t mode);

/**
  * @brief    Set pin mux function to iis2 master mck
  * @param    mck   Specific GPIO pin
  */
void pinmux_iis2_master_mck_init(uint16_t mck);

/**
  * @brief  Set pin mux function to iis2 slave ck
  * @param  ck   Specific GPIO pin
  */
void pinmux_iis2_slave_ck_init(uint16_t ck);

/**
  * @brief   Set pin mux function to iis2 slave ws
  * @param   ws  Specific GPIO pin
  */
void pinmux_iis2_slave_ws_init(uint16_t ws);
...
/**
  ...
  * @param   mode GPIO input/output mode
  */
void pinmux_iis2_slave_sd_init(uint16_t sd, uint8_t mode);

/**
  * @brief    Set pin mux function to iis2 slave mck
  * @param    mck   Specific GPIO pin
  */
void pinmux_iis2_slave_mck_init(uint16_t mck);
...
/**
  ...
  * @param  ck   Specific GPIO pin
  */
void pinmux_iis3_master_ck_init(uint16_t ck);

/**
  * @brief   Set pin mux function to iis3 master ws
  * @param   ws  Specific GPIO pin
  */
void pinmux_iis3_master_ws_init(uint16_t ws);
...
/**
  ...
  * @param   mode GPIO input/output mode
  */
void pinmux_iis3_master_sd_init(uint16_t sd, uint8_t mode);

/**
  * @brief    Set pin mux function to iis3 master mck
  * @param    mck   Specific GPIO pin
  */
void pinmux_iis3_master_mck_init(uint16_t mck);

/**
  * @brief  Set pin mux function to iis3 slave ck
  * @param  ck   Specific GPIO pin
  */
void pinmux_iis3_slave_ck_init(uint16_t ck);

/**
  * @brief   Set pin mux function to iis3 slave ws
  * @param   ws  Specific GPIO pin
  */
void pinmux_iis3_slave_ws_init(uint16_t ws);
...
/**
  ...
  * @param   mode GPIO input/output mode
  */
void pinmux_iis3_slave_sd_init(uint16_t sd, uint8_t mode);

/**
  * @brief    Set pin mux function to iis3 slave mck
  * @param    mck   Specific GPIO pin
  */
void pinmux_iis3_slave_mck_init(uint16_t mck);
...
/**
  ...
  */
void pinmux_spi2_master_clk_init(uint16_t clk, uint8_t cpol);

/**
  * @brief   Set pin mux function to spi2 master nss
  * @param  nss  Specific GPIO pin
  */
void pinmux_spi2_master_nss_init(uint16_t nss);

/**
  * @brief   Set pin mux function to spi2 master mosi
  * @param  mosi   Specific GPIO pin
  */
void pinmux_spi2_master_mosi_init(uint16_t mosi);

/**
  * @brief    Set pin mux function to spi2 master mosi
  * @param  miso   Specific GPIO pin
  */
void pinmux_spi2_master_miso_init(uint16_t miso);

/**
  * @brief  Set pin mux function to spi2 slave clk
  * @param  clk   Specific GPIO pin
  */
void pinmux_spi2_slave_clk_init(uint16_t clk);

/**
  * @brief   Set pin mux function to spi2 slave nss
  * @param  nss  Specific GPIO pin
  */
void pinmux_spi2_slave_nss_init(uint16_t nss);

/**
  * @brief   Set pin mux function to spi2 slave mosi
  * @param  mosi   Specific GPIO pin
  */
void pinmux_spi2_slave_mosi_init(uint16_t mosi);

/**
  * @brief    Set pin mux function to spi2 slave mosi
  * @param  miso   Specific GPIO pin
  */
void pinmux_spi2_slave_miso_init(uint16_t miso);

/**
  * @brief  Set pin mux function to spi3 master clk
  * @param  clk   Specific GPIO pin
  */
void pinmux_spi3_master_clk_init(uint16_t clk, uint8_t cpol);

/**
  * @brief   Set pin mux function to spi3 master nss
  * @param  nss  Specific GPIO pin
  */
void pinmux_spi3_master_nss_init(uint16_t nss);

/**
  * @brief   Set pin mux function to spi3 master mosi
  * @param  mosi   Specific GPIO pin
  */
void pinmux_spi3_master_mosi_init(uint16_t mosi);

/**
  * @brief    Set pin mux function to spi3 master mosi
  * @param  miso   Specific GPIO pin
  */
void pinmux_spi3_master_miso_init(uint16_t miso);

/**
  * @brief  Set pin mux function to spi3 slave clk
  * @param  clk   Specific GPIO pin
  */
void pinmux_spi3_slave_clk_init(uint16_t clk);

/**
  * @brief   Set pin mux function to spi3 slave nss
  * @param  nss  Specific GPIO pin
  */
void pinmux_spi3_slave_nss_init(uint16_t nss);

/**
  * @brief   Set pin mux function to spi3 slave mosi
  * @param  mosi   Specific GPIO pin
  */
void pinmux_spi3_slave_mosi_init(uint16_t mosi);

/**
  * @brief    Set pin mux function to spi3 slave mosi
  * @param  miso   Specific GPIO pin
  */
void pinmux_spi3_slave_miso_init(uint16_t miso);
...
/**
  ...
  */
void pinmux_iic1_init(uint16_t scl,uint16_t sda);
...
/**
  ...
  * @param  sda    Specific GPIO pin 
  */
void pinmux_iic2_init(uint16_t scl,uint16_t sda);
...
/**
  * @brief       Set pin mux function to dwuart3
  * @param  txd   Specific GPIO pin  
  * @param rxd   Specific GPIO pin   
  */
void pinmux_dwuart3_init(uint16_t txd,uint16_t rxd);

/**
  * @brief clear  pin mux function of dwuart3
  */
void pinmux_dwuart3_deinit(void);

/**
  * @brief       Set pin mux function to dwuart8
  * @param  txd   Specific GPIO pin  
  * @param rxd   Specific GPIO pin   
  */
...
/**
  * @brief clear  pin mux function of dwuart8
  */
...
/**
  ...
  */
void pinmux_adtim1_ch1_init(uint16_t pin,bool output,uint8_t default_val);
...
/**
  ...
  * @param  default_val  config pin output high level or low level 
  */
void pinmux_adtim1_ch2_init(uint16_t pin,bool output,uint8_t default_val);
...
/**
  ...
  * @param  default_val  config pin output high level or low level
  */
void pinmux_adtim1_ch3_init(uint16_t pin,bool output,uint8_t default_val);
...
/**
  ...
  * @param  default_val  config pin output high level or low level
  */
void pinmux_adtim1_ch4_init(uint16_t pin,bool output,uint8_t default_val);
...
/**
  ...
  * @param  pin  Specific GPIO pin 
  */
void pinmux_adtim1_ch1n_init(uint16_t pin);
...
void pinmux_adtim1_ch2n_init(uint16_t pin);
...
/**
  ...
  * @param  pin     Specific GPIO pin 
  */
void pinmux_adtim1_ch3n_init(uint16_t pin);
...
/**
  ...
  * @param  pin      Specific GPIO pin 
  */
void pinmux_adtim1_etr_init(uint16_t pin);
...
/**
  ...
  * @param  pin      Specific GPIO pin 
  */
void pinmux_adtim1_bk_init(uint16_t pin);
...
/**
  ...
  * @param  default_val  config pin output high level or low level
  */
void pinmux_gptima1_ch1_init(uint16_t pin,bool output,uint8_t default_val);
...
/**
  ...
  * @param  default_val  config pin output high level or low level
  */
void pinmux_gptima1_ch2_init(uint16_t pin,bool output,uint8_t default_val);
...
/**
  ...
  * @param  default_val  config pin output high level or low level
  */
void pinmux_gptima1_ch3_init(uint16_t pin,bool output,uint8_t default_val);
...
/**
  ...
  * @param  default_val  config pin output high level or low level
  */
void pinmux_gptima1_ch4_init(uint16_t pin,bool output,uint8_t default_val);
...
/**
  ...
  * @param  pin  Specific GPIO pin 
  */
void pinmux_gptima1_etr_init(uint16_t pin);
...
/**
  ...
  * @param  default_val  config pin output high level or low level
  */
void pinmux_gptimb1_ch1_init(uint16_t pin,bool output,uint8_t default_val);
...
/**
  ...
  * @param  default_val  config pin output high level or low level
  */
void pinmux_gptimb1_ch2_init(uint16_t pin,bool output,uint8_t default_val);
...
/**
  ...
  * @param  default_val  config pin output high level or low level
  */
void pinmux_gptimb1_ch3_init(uint16_t pin,bool output,uint8_t default_val);
...
/**
  ...
  * @param  default_val  config pin output high level or low level 
  */
void pinmux_gptimb1_ch4_init(uint16_t pin,bool output,uint8_t default_val);
...
/**
  ...
  * @param  pin  Specific GPIO pin 
  */
void pinmux_gptimb1_etr_init(uint16_t pin);
...
/**
  ...
  * @param  default_val  config pin output high level or low level 
  */
void pinmux_gptimc1_ch1_init(uint16_t pin,bool output,uint8_t default_val);
...
/**
  ...
  * @param  pin  Specific GPIO pin 
  */
void pinmux_gptimc1_ch1n_init(uint16_t pin);
...
/**
  ...
  * @param  default_val  config pin output high level or low level
  */
void pinmux_gptimc1_ch2_init(uint16_t pin,bool output,uint8_t default_val);
...
/**
  ...
  * @param  pin   Specific GPIO pin 
  */
void pinmux_gptimc1_bk_init(uint16_t pin);
...
/**
  ...
  * @param  pin   Specific GPIO pin 
  */
void pinmux_pdm_clk_init(uint16_t pin);
...
/**
  ...
  * @param  pin  Specific GPIO pin 
  */
void pinmux_pdm_data0_init(uint16_t pin);
...
/**
  ...
  * @param  pin  Specific GPIO pin 
  */
void pinmux_pdm_data1_init(uint16_t pin);
 ...
 */
void pinmux_comp1_init(uint16_t dat);
 ...
 * @param dat     Specific GPIO pin
 */
void pinmux_comp2_init(uint16_t dat);
 ...
 * @param dat     Specific GPIO pin
 */
void pinmux_comp3_init(uint16_t dat);
...
/**
  ...
  * @param  sda    Specific GPIO pin 
  */
void pinmux_iic3_init(uint16_t scl,uint16_t sda);
...
/**
  ...
  * @param  sda    Specific GPIO pin
  */
void pinmux_iic4_init(uint16_t scl,uint16_t sda);
...
/**
  ...
  * @param  sda    Specific GPIO pin
  */
void pinmux_iic5_init(uint16_t scl,uint16_t sda);
...
/**
  ...
  * @param  sda    Specific GPIO pin
  */
void pinmux_iic6_init(uint16_t scl,uint16_t sda);
...
void pinmux_iic7_init(uint16_t scl,uint16_t sda);
void pinmux_iic7_deinit(void);

void pinmux_iic8_init(uint16_t scl,uint16_t sda);
void pinmux_iic8_deinit(void);

void pinmux_iic9_init(uint16_t scl,uint16_t sda);
void pinmux_iic9_deinit(void);

void pinmux_iic10_init(uint16_t scl,uint16_t sda);
void pinmux_iic10_deinit(void);

void pinmux_iic11_init(uint16_t scl,uint16_t sda);
void pinmux_iic11_deinit(void);

void pinmux_iic12_init(uint16_t scl,uint16_t sda);
void pinmux_iic12_deinit(void);

void pinmux_iic13_init(uint16_t scl,uint16_t sda);
void pinmux_iic13_deinit(void);

void pinmux_iic14_init(uint16_t scl,uint16_t sda);
 ...
 * @param rxd      Specific GPIO pin 
 */
void pinmux_fdcan_init(uint16_t txd,uint16_t rxd);
 ...
 * @param pin      Specific GPIO pin 
 */
void pinmux_cec_init(uint16_t pin);
 ...
 * @param pin     Specific GPIO pin
 */
void pinmux_cap_ch1_init(uint16_t pin);
 ...
 * @param pin       Specific GPIO pin
 */
void pinmux_cap_ch2_init(uint16_t pin);
 ...
 * @param pin       Specific GPIO pin
 */
void pinmux_cap_ch3_init(uint16_t pin);
 ...
 * @param pin     Specific GPIO pin
 */
void pinmux_cap_ch4_init(uint16_t pin);
 ...
 * @param pin     Specific GPIO pin
 */
void pinmux_cap_ch5_init(uint16_t pin);
 ...
 * @param pin     Specific GPIO pin
 */
void pinmux_cap_ch6_init(uint16_t pin);
 ...
 * @param pin     Specific GPIO pin
 */
void pinmux_cap_ch7_init(uint16_t pin);
 ...
 * @param pin       Specific GPIO pin
 */
void pinmux_cap_ch8_init(uint16_t pin);
 ...
 * @param pin       Specific GPIO pin
 */
void pinmux_owm_init(uint16_t pin);
 ...
 * @param pin         Specific GPIO pin 
 */
void pinmux_pwm_ch1_init(uint16_t pin);
 ...
 * @param pin         Specific GPIO pin 
 */
void pinmux_pwm_ch2_init(uint16_t pin);
 ...
 * @param pin         Specific GPIO pin 
 */
void pinmux_pwm_ch3_init(uint16_t pin);
 ...
 * @param pin         Specific GPIO pin 
 */
void pinmux_pwm_ch4_init(uint16_t pin);
 ...
 * @param pin         Specific GPIO pin 
 */
void pinmux_pwm_ch5_init(uint16_t pin);
 ...
 * @param pin         Specific GPIO pin 
 */
void pinmux_pwm_ch6_init(uint16_t pin);
 ...
 * @param pin         Specific GPIO pin 
 */
void pinmux_pwm_ch7_init(uint16_t pin);
 ...
 * @param pin         Specific GPIO pin 
 */
void pinmux_pwm_ch8_init(uint16_t pin);
 ...
 * @param dat      Specific GPIO pin 
 */
void pinmux_ps2h1_init(uint16_t clk, uint16_t dat);
 ...
 * @param dat      Specific GPIO pin 
 */
void pinmux_ps2h2_init(uint16_t clk, uint16_t dat);
 ...
 * @param dat      Specific GPIO pin 
 */
void pinmux_ps2h3_init(uint16_t clk, uint16_t dat);
 ...
 * @param dat      Specific GPIO pin 
 */
void pinmux_ps2h4_init(uint16_t clk, uint16_t dat);
 ...
 */
void pinmux_kscan_init(uint16_t col_en, uint32_t row_en);
 ...
 */
void pinmux_usb_init(bool host, uint16_t dp, uint16_t dm);
 ...
 * @param pin      Specific GPIO pin 
 */
void pinmux_usb_otg_id_init(uint16_t pin);
