...
void HAL_LSOTBN_MSP_Init(void)
{
    ...
    CPU0_SYS_CFG -> CPU0_SYS_CRG_CPU0_SYS_AHB_CLK_TOP_RST_N_REG0_CLR = 0x40000;
    CPU0_SYS_CFG -> CPU0_SYS_CRG_CPU0_SYS_AHB_CLK_TOP_RST_N_REG0 = 0x40000;
    CPU0_SYS_CFG -> CPU0_SYS_CRG_SYS0_APB_CLK_TOP_RST_N_REG0_CLR = 0x10;
    CPU0_SYS_CFG -> CPU0_SYS_CRG_SYS0_APB_CLK_TOP_RST_N_REG0 = 0x10;
    CPU0_SYS_CFG -> CPU0_SYS_CRG_SYS0_APB_CLK_TOP_RST_N_REG0_CLR = 0x10000; 
    CPU0_SYS_CFG -> CPU0_SYS_CRG_SYS0_APB_CLK_TOP_RST_N_REG0 = 0x10000;
