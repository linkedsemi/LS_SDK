...
enum per_func
{
    ...
    UART2_CTSN  = FIO_UART2_CTSN,
    UART2_RTSN  = FIO_UART2_RTSN,
    /* UART 3 */
    UART3_TXD   = FIO_UART3_TXD,
    UART3_RXD   = FIO_UART3_RXD,
    UART3_CTSN  = FIO_UART3_CTSN,
    UART3_RTSN  = FIO_UART3_RTSN,
    /* UART 4 */
    DWUART1_TXD   = FIO_DWUART1_TXD,
    DWUART1_RXD   = FIO_DWUART1_RXD,
    DWUART1_CTSN  = FIO_DWUART1_CTSN,
    DWUART1_RTSN  = FIO_DWUART1_RTSN,
    /* UART 5 */
    DWUART2_TXD   = FIO_DWUART2_TXD,
    DWUART2_RXD   = FIO_DWUART2_RXD,
    DWUART2_CTSN = FIO_DWUART2_CTSN,
    DWUART2_RTSN = FIO_DWUART2_RTSN,
    /* SPI 1 */
