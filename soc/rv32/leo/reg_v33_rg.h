...
#define V33_RG ((reg_v33_rg_t *)APBIF_V33_BASE_ADDR)
...
typedef struct
{
    ...
    volatile uint32_t HSI_FC_EN; //0x40
    volatile uint32_t WKUP_TIM1; //0x44
    volatile uint32_t GPIO_FIR; //0x48
    volatile uint32_t RESERVED0[1];
    volatile uint32_t OP_CTRL; //0x50
    volatile uint32_t COMP1_CTRL; //0x54
    volatile uint32_t COMP2_CTRL; //0x58
    volatile uint32_t COMP3_CTRL; //0x5c
    volatile uint32_t COMP_STAT; //0x60
    volatile uint32_t VREF_OK; //0x64
    volatile uint32_t RESERVED1[3];
    volatile uint32_t RST_SRC; //0x74
    volatile uint32_t EXT_INTR; //0x78
    volatile uint32_t CLK_STAT; //0x7c
    volatile uint32_t GPIO_INTR_MSK[8]; //0x80
    volatile uint32_t GPIO_INTR_CLR[8]; //0xa0
    volatile uint32_t GPIO_INTR_STT[8]; //0xc0
    volatile uint32_t GPIO_INTR_RAW[8]; //0xe0
}reg_v33_rg_t;
...
enum V33_RG_REG_MISC_CTRL0_FIELD
{
    ...
    V33_RG_LKRST_SEL_MASK = (int)0x1f000000,
    V33_RG_LKRST_SEL_POS = 24,
};
...
enum V33_RG_REG_TRIM0_FIELD
{
    ...
    V33_RG_HSE_CTRL_MASK = (int)0x7000,
    V33_RG_HSE_CTRL_POS = 12,
    V33_RG_LDO_PECI_VSEL_MASK = (int)0x70000,
    V33_RG_LDO_PECI_VSEL_POS = 16,
    ...
    V33_RG_RCO_I_ADJ_MASK = (int)0x4000000,
    V33_RG_RCO_I_ADJ_POS = 26,
...
enum V33_RG_REG_ANA_PMU_CTRL_FIELD
{
    ...
    V33_RG_LPLDO_CL_CTRL_MASK = (int)0x40,
    V33_RG_LPLDO_CL_CTRL_POS = 6,
    ...
    V33_RG_BAT_DET_CTRL_MASK = (int)0xe0000000,
    V33_RG_BAT_DET_CTRL_POS = 29,
};
...
enum V33_RG_REG_HSI_FC_EN_FIELD
{
    V33_RG_HSI_FS_EN_MASK = (int)0x1,
    V33_RG_HSI_FS_EN_POS = 0,
};
...
enum V33_RG_REG_WKUP_TIM1_FIELD
{
    ...
    V33_RG_STB_HSI_M1_MASK = (int)0xf0000,
    V33_RG_STB_HSI_M1_POS = 16,
};
