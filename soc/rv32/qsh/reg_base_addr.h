...
#define QSH_APB_CPU_ADDR           (0x40012000)
#define QSH_APB_AWO_ADDR           (0x40013000)
...
#define QSH_APB_PMU_RG_ADDR        (0x4001F000)
#define QSH_APB_PMU_TIM_ADDR       (0x4001F400)
#define QSH_APB_PMU_WDT_ADDR       (0x4001F800)
#define QSH_APB_PMU_RTC_ADDR       (0x4001FC00)
