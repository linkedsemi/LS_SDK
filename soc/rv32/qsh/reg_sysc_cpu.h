...
typedef struct
{
    ...
    volatile uint32_t OTBN_INTR_MSK; //0x60
    volatile uint32_t OTBN_INTR_CLR; //0x64
...
enum SYSC_CPU_REG_OTBN_INTR_MSK_FIELD
{
    SYSC_CPU_OTBN_INTR_MSK_MASK = (int)0x7ff,
    SYSC_CPU_OTBN_INTR_MSK_POS = 0,
};

enum SYSC_CPU_REG_OTBN_INTR_CLR_FIELD
{
    SYSC_CPU_OTBN_INTR_CLR_MASK = (int)0x7ff,
    SYSC_CPU_OTBN_INTR_CLR_POS = 0,
};

enum SYSC_CPU_REG_OTBN_INTR_STT_FIELD
{
    SYSC_CPU_OTBN_INTR_STT_MASK = (int)0x7ff,
    SYSC_CPU_OTBN_INTR_STT_POS = 0,
};

enum SYSC_CPU_REG_OTBN_INTR_RAW_FIELD
{
    SYSC_CPU_OTBN_INTR_RAW_MASK = (int)0x7ff,
    SYSC_CPU_OTBN_INTR_RAW_POS = 0,
};
