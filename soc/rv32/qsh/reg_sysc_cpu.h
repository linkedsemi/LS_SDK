...
enum SYSC_CPU_REG_SYS_CLK_FIELD
{
    ...
    SYSC_CPU_CLKG_USB2_CTL_MASK = (int)0x40,
    SYSC_CPU_CLKG_USB2_CTL_POS = 6,
};
...
{
    SYSC_CPU_APP_CPU_SRST_SET_MASK = (int)0x1,
    SYSC_CPU_APP_CPU_SRST_SET_POS = 0,
    SYSC_CPU_APP_CPU_SRST_CLR_MASK = (int)0x2,
    SYSC_CPU_APP_CPU_SRST_CLR_POS = 1,
};
...
enum SYSC_CPU_REG_PD_CPU_CLKG0_FIELD
{
    ...
    SYSC_CPU_CLKG_SET_LPC1_MASK = (int)0x400000,
    SYSC_CPU_CLKG_SET_LPC1_POS = 22,
    SYSC_CPU_CLKG_CLR_LPC1_MASK = (int)0x800000,
    SYSC_CPU_CLKG_CLR_LPC1_POS = 23,
    ...
    SYSC_CPU_CLKG_SET_ETH1_MASK = (int)0x4000000,
    SYSC_CPU_CLKG_SET_ETH1_POS = 26,
    SYSC_CPU_CLKG_CLR_ETH1_MASK = (int)0x8000000,
    SYSC_CPU_CLKG_CLR_ETH1_POS = 27,
    SYSC_CPU_CLKG_SET_EMMC1_MASK = (int)0x10000000,
    SYSC_CPU_CLKG_SET_EMMC1_POS = 28,
    SYSC_CPU_CLKG_CLR_EMMC1_MASK = (int)0x20000000,
    SYSC_CPU_CLKG_CLR_EMMC1_POS = 29,
    SYSC_CPU_CLKG_SET_LPC2_MASK = (int)0x40000000,
    SYSC_CPU_CLKG_SET_LPC2_POS = 30,
    SYSC_CPU_CLKG_CLR_LPC2_MASK = (int)0x80000000,
    SYSC_CPU_CLKG_CLR_LPC2_POS = 31,
};
...
enum SYSC_CPU_REG_PD_CPU_CLKG1_FIELD
{
    ...
    SYSC_CPU_CLKG_SET_OTP_CTRL_MASK = (int)0x40,
    SYSC_CPU_CLKG_SET_OTP_CTRL_POS = 6,
    SYSC_CPU_CLKG_CLR_OTP_CTRL_MASK = (int)0x80,
    SYSC_CPU_CLKG_CLR_OTP_CTRL_POS = 7,
    ...
    SYSC_CPU_CLKG_SET_ETH2_MASK = (int)0x40000,
    SYSC_CPU_CLKG_SET_ETH2_POS = 18,
    SYSC_CPU_CLKG_CLR_ETH2_MASK = (int)0x80000,
    SYSC_CPU_CLKG_CLR_ETH2_POS = 19,
    SYSC_CPU_CLKG_SET_EMMC2_MASK = (int)0x100000,
    SYSC_CPU_CLKG_SET_EMMC2_POS = 20,
    SYSC_CPU_CLKG_CLR_EMMC2_MASK = (int)0x200000,
    SYSC_CPU_CLKG_CLR_EMMC2_POS = 21,
    SYSC_CPU_CLKG_SET_PSRAM_MASK = (int)0x400000,
    SYSC_CPU_CLKG_SET_PSRAM_POS = 22,
    SYSC_CPU_CLKG_CLR_PSRAM_MASK = (int)0x800000,
    SYSC_CPU_CLKG_CLR_PSRAM_POS = 23,
    SYSC_CPU_CLKG_SET_LTPI_SCM_MASK = (int)0x1000000,
    SYSC_CPU_CLKG_SET_LTPI_SCM_POS = 24,
    SYSC_CPU_CLKG_CLR_LTPI_SCM_MASK = (int)0x2000000,
    SYSC_CPU_CLKG_CLR_LTPI_SCM_POS = 25,
    SYSC_CPU_CLKG_SET_LTPI_HPM_MASK = (int)0x4000000,
    SYSC_CPU_CLKG_SET_LTPI_HPM_POS = 26,
    SYSC_CPU_CLKG_CLR_LTPI_HPM_MASK = (int)0x8000000,
    SYSC_CPU_CLKG_CLR_LTPI_HPM_POS = 27,
    SYSC_CPU_CLKG_SET_LTPI_PHY_MASK = (int)0x10000000,
    SYSC_CPU_CLKG_SET_LTPI_PHY_POS = 28,
    SYSC_CPU_CLKG_CLR_LTPI_PHY_MASK = (int)0x20000000,
    SYSC_CPU_CLKG_CLR_LTPI_PHY_POS = 29,
    SYSC_CPU_CLKG_SET_NIST_TRNG_MASK = (int)0x40000000,
    SYSC_CPU_CLKG_SET_NIST_TRNG_POS = 30,
    SYSC_CPU_CLKG_CLR_NIST_TRNG_MASK = (int)0x80000000,
    SYSC_CPU_CLKG_CLR_NIST_TRNG_POS = 31,
};
...
enum SYSC_CPU_REG_PD_CPU_SRST_FIELD
{
    ...
    SYSC_CPU_SRST_SET_LPC1_MASK = (int)0x400000,
    SYSC_CPU_SRST_SET_LPC1_POS = 22,
    SYSC_CPU_SRST_CLR_LPC1_MASK = (int)0x800000,
    SYSC_CPU_SRST_CLR_LPC1_POS = 23,
    ...
    SYSC_CPU_SRST_SET_ETH1_MASK = (int)0x4000000,
    SYSC_CPU_SRST_SET_ETH1_POS = 26,
    SYSC_CPU_SRST_CLR_ETH1_MASK = (int)0x8000000,
    SYSC_CPU_SRST_CLR_ETH1_POS = 27,
    SYSC_CPU_SRST_SET_EMMC1_MASK = (int)0x10000000,
    SYSC_CPU_SRST_SET_EMMC1_POS = 28,
    SYSC_CPU_SRST_CLR_EMMC1_MASK = (int)0x20000000,
    SYSC_CPU_SRST_CLR_EMMC1_POS = 29,
    SYSC_CPU_SRST_SET_LPC2_MASK = (int)0x40000000,
    SYSC_CPU_SRST_SET_LPC2_POS = 30,
    SYSC_CPU_SRST_CLR_LPC2_MASK = (int)0x80000000,
    SYSC_CPU_SRST_CLR_LPC2_POS = 31,
};
...
enum SYSC_CPU_REG_PD_CPU_SRST1_FIELD
{
    ...
    SYSC_CPU_SRST_SET_OTP_CTRL_MASK = (int)0x40,
    SYSC_CPU_SRST_SET_OTP_CTRL_POS = 6,
    SYSC_CPU_SRST_CLR_OTP_CTRL_MASK = (int)0x80,
    SYSC_CPU_SRST_CLR_OTP_CTRL_POS = 7,
    ...
    SYSC_CPU_SRST_SET_ETH2_MASK = (int)0x40000,
    SYSC_CPU_SRST_SET_ETH2_POS = 18,
    SYSC_CPU_SRST_CLR_ETH2_MASK = (int)0x80000,
    SYSC_CPU_SRST_CLR_ETH2_POS = 19,
    SYSC_CPU_SRST_SET_EMMC2_MASK = (int)0x100000,
    SYSC_CPU_SRST_SET_EMMC2_POS = 20,
    SYSC_CPU_SRST_CLR_EMMC2_MASK = (int)0x200000,
    SYSC_CPU_SRST_CLR_EMMC2_POS = 21,
    SYSC_CPU_SRST_SET_PSRAM2_MASK = (int)0x400000,
    SYSC_CPU_SRST_SET_PSRAM2_POS = 22,
    SYSC_CPU_SRST_CLR_PSRAM2_MASK = (int)0x800000,
    SYSC_CPU_SRST_CLR_PSRAM2_POS = 23,
    SYSC_CPU_SRST_SET_LTPI_SCM_MASK = (int)0x1000000,
    SYSC_CPU_SRST_SET_LTPI_SCM_POS = 24,
    SYSC_CPU_SRST_CLR_LTPI_SCM_MASK = (int)0x2000000,
    SYSC_CPU_SRST_CLR_LTPI_SCM_POS = 25,
    SYSC_CPU_SRST_SET_LTPI_HPM_MASK = (int)0x4000000,
    SYSC_CPU_SRST_SET_LTPI_HPM_POS = 26,
    SYSC_CPU_SRST_CLR_LTPI_HPM_MASK = (int)0x8000000,
    SYSC_CPU_SRST_CLR_LTPI_HPM_POS = 27,
    SYSC_CPU_SRST_SET_LTPI_PHY_MASK = (int)0x10000000,
    SYSC_CPU_SRST_SET_LTPI_PHY_POS = 28,
    SYSC_CPU_SRST_CLR_LTPI_PHY_MASK = (int)0x20000000,
    SYSC_CPU_SRST_CLR_LTPI_PHY_POS = 29,
    SYSC_CPU_SRST_SET_NIST_TRNG_MASK = (int)0x40000000,
    SYSC_CPU_SRST_SET_NIST_TRNG_POS = 30,
    SYSC_CPU_SRST_CLR_NIST_TRNG_MASK = (int)0x80000000,
    SYSC_CPU_SRST_CLR_NIST_TRNG_POS = 31,
};
...
enum SYSC_CPU_REG_NIST_TRNG_CTRL_FIELD
{
    SYSC_CPU_NIST_TRNG_TEST_MODE_MASK = (int)0x3,
    SYSC_CPU_NIST_TRNG_TEST_MODE_POS = 0,
    SYSC_CPU_NIST_TRNG_TEST_TWEAK_MUX_MASK = (int)0xc,
    SYSC_CPU_NIST_TRNG_TEST_TWEAK_MUX_POS = 2,
    SYSC_CPU_NIST_TRNG_CTL_ZEROIZE_MASK = (int)0x10,
    SYSC_CPU_NIST_TRNG_CTL_ZEROIZE_POS = 4,
    SYSC_CPU_NIST_TRNG_CTL_ALARM_MASK = (int)0x20,
    SYSC_CPU_NIST_TRNG_CTL_ALARM_POS = 5,
    SYSC_CPU_NIST_TRNG_CTL_NONCE_MODE_MASK = (int)0x40,
    SYSC_CPU_NIST_TRNG_CTL_NONCE_MODE_POS = 6,
    SYSC_CPU_NIST_TRNG_CTL_SECURE_MODE_MASK = (int)0x80,
    SYSC_CPU_NIST_TRNG_CTL_SECURE_MODE_POS = 7,
    SYSC_CPU_NIST_TRNG_TEST_TP_MASK = (int)0x7ffff00,
    SYSC_CPU_NIST_TRNG_TEST_TP_POS = 8,
};
...
{
    SYSC_CPU_OTBN_TX0_ALERT_P_MSK_MASK = (int)0x1,
    SYSC_CPU_OTBN_TX0_ALERT_P_MSK_POS = 0,
    SYSC_CPU_OTBN_TX0_ALERT_N_MSK_MASK = (int)0x2,
    SYSC_CPU_OTBN_TX0_ALERT_N_MSK_POS = 1,
    SYSC_CPU_OTBN_TX1_ALERT_P_MSK_MASK = (int)0x4,
    SYSC_CPU_OTBN_TX1_ALERT_P_MSK_POS = 2,
    SYSC_CPU_OTBN_TX1_ALERT_N_MSK_MASK = (int)0x8,
    SYSC_CPU_OTBN_TX1_ALERT_N_MSK_POS = 3,
    SYSC_CPU_OTBN_LC_RMA_ACK0_MSK_MASK = (int)0x10,
    SYSC_CPU_OTBN_LC_RMA_ACK0_MSK_POS = 4,
    SYSC_CPU_OTBN_LC_RMA_ACK1_MSK_MASK = (int)0x20,
    SYSC_CPU_OTBN_LC_RMA_ACK1_MSK_POS = 5,
    SYSC_CPU_OTBN_LC_RMA_ACK2_MSK_MASK = (int)0x40,
    SYSC_CPU_OTBN_LC_RMA_ACK2_MSK_POS = 6,
    SYSC_CPU_OTBN_LC_RMA_ACK3_MSK_MASK = (int)0x80,
    SYSC_CPU_OTBN_LC_RMA_ACK3_MSK_POS = 7,
    SYSC_CPU_OTBN_EDN_RND_REQ_MSK_MASK = (int)0x100,
    SYSC_CPU_OTBN_EDN_RND_REQ_MSK_POS = 8,
    SYSC_CPU_OTBN_EDN_URND_REQ_MSK_MASK = (int)0x200,
    SYSC_CPU_OTBN_EDN_URND_REQ_MSK_POS = 9,
    SYSC_CPU_OTBN_OTP_REQ_MSK_MASK = (int)0x400,
    SYSC_CPU_OTBN_OTP_REQ_MSK_POS = 10,
    SYSC_CPU_SPID1_MSK_MASK = (int)0x30000,
    SYSC_CPU_SPID1_MSK_POS = 16,
    SYSC_CPU_SPID2_MSK_MASK = (int)0x300000,
    SYSC_CPU_SPID2_MSK_POS = 20,
};

enum SYSC_CPU_REG_INTR_CLR_MSK_FIELD
{
    SYSC_CPU_OTBN_TX0_ALERT_P_CLR_MASK = (int)0x1,
    SYSC_CPU_OTBN_TX0_ALERT_P_CLR_POS = 0,
    SYSC_CPU_OTBN_TX0_ALERT_N_CLR_MASK = (int)0x2,
    SYSC_CPU_OTBN_TX0_ALERT_N_CLR_POS = 1,
    SYSC_CPU_OTBN_TX1_ALERT_P_CLR_MASK = (int)0x4,
    SYSC_CPU_OTBN_TX1_ALERT_P_CLR_POS = 2,
    SYSC_CPU_OTBN_TX1_ALERT_N_CLR_MASK = (int)0x8,
    SYSC_CPU_OTBN_TX1_ALERT_N_CLR_POS = 3,
    SYSC_CPU_OTBN_LC_RMA_ACK0_CLR_MASK = (int)0x10,
    SYSC_CPU_OTBN_LC_RMA_ACK0_CLR_POS = 4,
    SYSC_CPU_OTBN_LC_RMA_ACK1_CLR_MASK = (int)0x20,
    SYSC_CPU_OTBN_LC_RMA_ACK1_CLR_POS = 5,
    SYSC_CPU_OTBN_LC_RMA_ACK2_CLR_MASK = (int)0x40,
    SYSC_CPU_OTBN_LC_RMA_ACK2_CLR_POS = 6,
    SYSC_CPU_OTBN_LC_RMA_ACK3_CLR_MASK = (int)0x80,
    SYSC_CPU_OTBN_LC_RMA_ACK3_CLR_POS = 7,
    SYSC_CPU_OTBN_EDN_RND_REQ_CLR_MASK = (int)0x100,
    SYSC_CPU_OTBN_EDN_RND_REQ_CLR_POS = 8,
    SYSC_CPU_OTBN_EDN_URND_REQ_CLR_MASK = (int)0x200,
    SYSC_CPU_OTBN_EDN_URND_REQ_CLR_POS = 9,
    SYSC_CPU_OTBN_OTP_REQ_CLR_MASK = (int)0x400,
    SYSC_CPU_OTBN_OTP_REQ_CLR_POS = 10,
    SYSC_CPU_SPID1_CLR_MASK = (int)0x30000,
    SYSC_CPU_SPID1_CLR_POS = 16,
    SYSC_CPU_SPID2_CLR_MASK = (int)0x300000,
    SYSC_CPU_SPID2_CLR_POS = 20,
};

enum SYSC_CPU_REG_OTBN_INTR_STT_FIELD
{
    SYSC_CPU_OTBN_TX0_ALERT_P_STT_MASK = (int)0x1,
    SYSC_CPU_OTBN_TX0_ALERT_P_STT_POS = 0,
    SYSC_CPU_OTBN_TX0_ALERT_N_STT_MASK = (int)0x2,
    SYSC_CPU_OTBN_TX0_ALERT_N_STT_POS = 1,
    SYSC_CPU_OTBN_TX1_ALERT_P_STT_MASK = (int)0x4,
    SYSC_CPU_OTBN_TX1_ALERT_P_STT_POS = 2,
    SYSC_CPU_OTBN_TX1_ALERT_N_STT_MASK = (int)0x8,
    SYSC_CPU_OTBN_TX1_ALERT_N_STT_POS = 3,
    SYSC_CPU_OTBN_LC_RMA_ACK0_STT_MASK = (int)0x10,
    SYSC_CPU_OTBN_LC_RMA_ACK0_STT_POS = 4,
    SYSC_CPU_OTBN_LC_RMA_ACK1_STT_MASK = (int)0x20,
    SYSC_CPU_OTBN_LC_RMA_ACK1_STT_POS = 5,
    SYSC_CPU_OTBN_LC_RMA_ACK2_STT_MASK = (int)0x40,
    SYSC_CPU_OTBN_LC_RMA_ACK2_STT_POS = 6,
    SYSC_CPU_OTBN_LC_RMA_ACK3_STT_MASK = (int)0x80,
    SYSC_CPU_OTBN_LC_RMA_ACK3_STT_POS = 7,
    SYSC_CPU_OTBN_EDN_RND_REQ_STT_MASK = (int)0x100,
    SYSC_CPU_OTBN_EDN_RND_REQ_STT_POS = 8,
    SYSC_CPU_OTBN_EDN_URND_REQ_STT_MASK = (int)0x200,
    SYSC_CPU_OTBN_EDN_URND_REQ_STT_POS = 9,
    SYSC_CPU_OTBN_OTP_REQ_STT_MASK = (int)0x400,
    SYSC_CPU_OTBN_OTP_REQ_STT_POS = 10,
    SYSC_CPU_SPID1_STT_MASK = (int)0x30000,
    SYSC_CPU_SPID1_STT_POS = 16,
    SYSC_CPU_SPID2_STT_MASK = (int)0x300000,
    SYSC_CPU_SPID2_STT_POS = 20,
};

enum SYSC_CPU_REG_OTBN_INTR_RAW_FIELD
{
    SYSC_CPU_OTBN_TX0_ALERT_P_RAW_MASK = (int)0x1,
    SYSC_CPU_OTBN_TX0_ALERT_P_RAW_POS = 0,
    SYSC_CPU_OTBN_TX0_ALERT_N_RAW_MASK = (int)0x2,
    SYSC_CPU_OTBN_TX0_ALERT_N_RAW_POS = 1,
    SYSC_CPU_OTBN_TX1_ALERT_P_RAW_MASK = (int)0x4,
    SYSC_CPU_OTBN_TX1_ALERT_P_RAW_POS = 2,
    SYSC_CPU_OTBN_TX1_ALERT_N_RAW_MASK = (int)0x8,
    SYSC_CPU_OTBN_TX1_ALERT_N_RAW_POS = 3,
    SYSC_CPU_OTBN_LC_RMA_ACK0_RAW_MASK = (int)0x10,
    SYSC_CPU_OTBN_LC_RMA_ACK0_RAW_POS = 4,
    SYSC_CPU_OTBN_LC_RMA_ACK1_RAW_MASK = (int)0x20,
    SYSC_CPU_OTBN_LC_RMA_ACK1_RAW_POS = 5,
    SYSC_CPU_OTBN_LC_RMA_ACK2_RAW_MASK = (int)0x40,
    SYSC_CPU_OTBN_LC_RMA_ACK2_RAW_POS = 6,
    SYSC_CPU_OTBN_LC_RMA_ACK3_RAW_MASK = (int)0x80,
    SYSC_CPU_OTBN_LC_RMA_ACK3_RAW_POS = 7,
    SYSC_CPU_OTBN_EDN_RND_REQ_RAW_MASK = (int)0x100,
    SYSC_CPU_OTBN_EDN_RND_REQ_RAW_POS = 8,
    SYSC_CPU_OTBN_EDN_URND_REQ_RAW_MASK = (int)0x200,
    SYSC_CPU_OTBN_EDN_URND_REQ_RAW_POS = 9,
    SYSC_CPU_OTBN_OTP_REQ_RAW_MASK = (int)0x400,
    SYSC_CPU_OTBN_OTP_REQ_RAW_POS = 10,
    SYSC_CPU_SPID1_RAW_MASK = (int)0x30000,
    SYSC_CPU_SPID1_RAW_POS = 16,
    SYSC_CPU_SPID2_RAW_MASK = (int)0x300000,
    SYSC_CPU_SPID2_RAW_POS = 20,
};
...
enum SYSC_CPU_REG_ETH1_PHY_CTRL_FIELD
{
    SYSC_CPU_ETH1_PHY_INTF_SEL_MASK = (int)0x7,
    SYSC_CPU_ETH1_PHY_INTF_SEL_POS = 0,
    SYSC_CPU_ETH1_PHY_SEL_MASK = (int)0x8,
    SYSC_CPU_ETH1_PHY_SEL_POS = 3,
    SYSC_CPU_ETH1_PHY_INTR_MASK = (int)0x10,
    SYSC_CPU_ETH1_PHY_INTR_POS = 4,
    SYSC_CPU_ETH1_RMII_PAD_MODE_MASK = (int)0xc0,
    SYSC_CPU_ETH1_RMII_PAD_MODE_POS = 6,
    SYSC_CPU_ETH1_RGMII_DLY_CTL_MASK = (int)0xff00,
    SYSC_CPU_ETH1_RGMII_DLY_CTL_POS = 8,
    SYSC_CPU_ETH1_MDC_CHID_MASK = (int)0x3000000,
    SYSC_CPU_ETH1_MDC_CHID_POS = 24,
};

enum SYSC_CPU_REG_ETH2_PHY_CTRL_FIELD
{
    SYSC_CPU_ETH2_PHY_INTF_SEL_MASK = (int)0x7,
    SYSC_CPU_ETH2_PHY_INTF_SEL_POS = 0,
    SYSC_CPU_ETH2_PHY_SEL_MASK = (int)0x8,
    SYSC_CPU_ETH2_PHY_SEL_POS = 3,
    SYSC_CPU_ETH2_PHY_INTR_MASK = (int)0x10,
    SYSC_CPU_ETH2_PHY_INTR_POS = 4,
    SYSC_CPU_ETH2_RMII_PAD_MODE_MASK = (int)0xc0,
    SYSC_CPU_ETH2_RMII_PAD_MODE_POS = 6,
    SYSC_CPU_ETH2_RGMII_DLY_CTL_MASK = (int)0x1ff00,
    SYSC_CPU_ETH2_RGMII_DLY_CTL_POS = 8,
    SYSC_CPU_ETH2_MDC_CHID_MASK = (int)0x3000000,
    SYSC_CPU_ETH2_MDC_CHID_POS = 24,
};

enum SYSC_CPU_REG_EMMC1_DLL_CTRL_FIELD
{
    SYSC_CPU_EMMC1_DLL_CTRL_MASK = (int)0xffffff,
    SYSC_CPU_EMMC1_DLL_CTRL_POS = 0,
    SYSC_CPU_EMMC1_DLL_CTRL_RD_MASK = (int)0xff000000,
    SYSC_CPU_EMMC1_DLL_CTRL_RD_POS = 24,
};

enum SYSC_CPU_REG_EMMC1_CTRL_FIELD
{
    SYSC_CPU_EMMC1_TX_CLK_DLY_CTL_MASK = (int)0x1ff,
    SYSC_CPU_EMMC1_TX_CLK_DLY_CTL_POS = 0,
    SYSC_CPU_EMMC1_AUTO_TUNING_MASK = (int)0x400,
    SYSC_CPU_EMMC1_AUTO_TUNING_POS = 10,
    SYSC_CPU_EMMC1_TX_DLL_SEL_MASK = (int)0x800,
    SYSC_CPU_EMMC1_TX_DLL_SEL_POS = 11,
    SYSC_CPU_EMMC1_TX_CLK_SEL_MASK = (int)0x3000,
    SYSC_CPU_EMMC1_TX_CLK_SEL_POS = 12,
    SYSC_CPU_EMMC1_RX_CLK_SEL_MASK = (int)0xc000,
    SYSC_CPU_EMMC1_RX_CLK_SEL_POS = 14,
    SYSC_CPU_EMMC1_RX_CLK_DLY_CTL_MASK = (int)0x1ff0000,
    SYSC_CPU_EMMC1_RX_CLK_DLY_CTL_POS = 16,
    SYSC_CPU_EMMC1_CARD_DETECT_N_MASK = (int)0x2000000,
    SYSC_CPU_EMMC1_CARD_DETECT_N_POS = 25,
    SYSC_CPU_EMMC1_CARD_WRITE_PROT_MASK = (int)0x4000000,
    SYSC_CPU_EMMC1_CARD_WRITE_PROT_POS = 26,
};

enum SYSC_CPU_REG_EMMC2_DLL_CTRL_FIELD
{
    SYSC_CPU_EMMC2_DLL_CTRL_MASK = (int)0xffffff,
    SYSC_CPU_EMMC2_DLL_CTRL_POS = 0,
    SYSC_CPU_EMMC2_DLL_CTRL_RD_MASK = (int)0xff000000,
    SYSC_CPU_EMMC2_DLL_CTRL_RD_POS = 24,
};

enum SYSC_CPU_REG_EMMC2_CTRL_FIELD
{
    SYSC_CPU_EMMC2_TX_CLK_DLY_CTL_MASK = (int)0x1ff,
    SYSC_CPU_EMMC2_TX_CLK_DLY_CTL_POS = 0,
    SYSC_CPU_EMMC2_AUTO_TUNING_MASK = (int)0x400,
    SYSC_CPU_EMMC2_AUTO_TUNING_POS = 10,
    SYSC_CPU_EMMC2_TX_DLL_SEL_MASK = (int)0x800,
    SYSC_CPU_EMMC2_TX_DLL_SEL_POS = 11,
    SYSC_CPU_EMMC2_TX_CLK_SEL_MASK = (int)0x3000,
    SYSC_CPU_EMMC2_TX_CLK_SEL_POS = 12,
    SYSC_CPU_EMMC2_RX_CLK_SEL_MASK = (int)0xc000,
    SYSC_CPU_EMMC2_RX_CLK_SEL_POS = 14,
    SYSC_CPU_EMMC2_RX_CLK_DLY_CTL_MASK = (int)0x1ff0000,
    SYSC_CPU_EMMC2_RX_CLK_DLY_CTL_POS = 16,
    SYSC_CPU_EMMC2_CARD_DETECT_N_MASK = (int)0x2000000,
    SYSC_CPU_EMMC2_CARD_DETECT_N_POS = 25,
    SYSC_CPU_EMMC2_CARD_WRITE_PROT_MASK = (int)0x4000000,
    SYSC_CPU_EMMC2_CARD_WRITE_PROT_POS = 26,
};

enum SYSC_CPU_REG_PSRAM_CTRL_FIELD
{
    SYSC_CPU_PSRAM_XIP_EN_MASK = (int)0x1,
    SYSC_CPU_PSRAM_XIP_EN_POS = 0,
    SYSC_CPU_PSRAM_SLV_SEL_MASK = (int)0x2,
    SYSC_CPU_PSRAM_SLV_SEL_POS = 1,
    SYSC_CPU_PSRAM_CSN_IN_MASK = (int)0x4,
    SYSC_CPU_PSRAM_CSN_IN_POS = 2,
    SYSC_CPU_PSRAM_MODE_MASK = (int)0x30,
    SYSC_CPU_PSRAM_MODE_POS = 4,
    SYSC_CPU_PSRAM_SLEEP_MASK = (int)0x40,
    SYSC_CPU_PSRAM_SLEEP_POS = 6,
};
