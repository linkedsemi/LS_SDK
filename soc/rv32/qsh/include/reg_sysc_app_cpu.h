...
enum SYSC_APP_CPU_REG_ETH1_PHY_CTRL_FIELD {
    ...
    SYSC_APP_CPU_ETH1_RGMII_TX_INV_MASK = (int)0x100,
    SYSC_APP_CPU_ETH1_RGMII_TX_INV_POS = 8,
    SYSC_APP_CPU_ETH1_RGMII_TX_DELAY_SEL_MASK = (int)0xe00,
    SYSC_APP_CPU_ETH1_RGMII_TX_DELAY_SEL_POS = 9,
    SYSC_APP_CPU_ETH1_RGMII_RX_INV_MASK = (int)0x1000,
    SYSC_APP_CPU_ETH1_RGMII_RX_INV_POS = 12,
    SYSC_APP_CPU_ETH1_RGMII_RX_DELAY_SEL_MASK = (int)0xe000,
    SYSC_APP_CPU_ETH1_RGMII_RX_DELAY_SEL_POS = 13,
...
enum SYSC_APP_CPU_REG_ETH2_PHY_CTRL_FIELD {
    ...
    SYSC_APP_CPU_ETH2_RGMII_DLY_CTL_MASK = (int)0xff00,
    SYSC_APP_CPU_ETH2_RGMII_DLY_CTL_POS = 8,
    SYSC_APP_CPU_ETH2_RGMII_TX_INV_MASK = (int)0x100,
    SYSC_APP_CPU_ETH2_RGMII_TX_INV_POS = 8,
    SYSC_APP_CPU_ETH2_RGMII_TX_DELAY_SEL_MASK = (int)0xe00,
    SYSC_APP_CPU_ETH2_RGMII_TX_DELAY_SEL_POS = 9,
    SYSC_APP_CPU_ETH2_RGMII_RX_INV_MASK = (int)0x1000,
    SYSC_APP_CPU_ETH2_RGMII_RX_INV_POS = 12,
    SYSC_APP_CPU_ETH2_RGMII_RX_DELAY_SEL_MASK = (int)0xe000,
    SYSC_APP_CPU_ETH2_RGMII_RX_DELAY_SEL_POS = 13,
...
enum SYSC_APP_CPU_REG_EMMC1_DLL_CTRL_FIELD {
    ...
    SYSC_APP_CPU_EMMC1_DLL_CTRL_DECODER_R_MASK = (int)0x7f,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_DECODER_R_POS = 0,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_DLL_CTRL_REG_INV_MASK = (int)0x80,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_DLL_CTRL_REG_INV_POS = 7,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_PHASE_DETECT_SEL_N_MASK = (int)0x700,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_PHASE_DETECT_SEL_N_POS = 8,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_PRE_CLK_GATE_CTL_MASK = (int)0x800,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_PRE_CLK_GATE_CTL_POS = 0,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_HALF_CLOCK_MODE_MASK = (int)0x2000,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_HALF_CLOCK_MODE_POS = 0,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_RD_MASK = (int)0xff000000,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_RD_POS = 24,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_RD_LOCK_MASK = (int)0x1000000,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_RD_LOCK_POS = 24,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_RD_PHASE1_MASK = (int)0x2000000,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_RD_PHASE1_POS = 25,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_RD_PHASE2_MASK = (int)0x4000000,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_RD_PHASE2_POS = 26,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_RD_SIGO_0_TESTPOINT_S_MASK = (int)0x8000000,
    SYSC_APP_CPU_EMMC1_DLL_CTRL_RD_SIGO_0_TESTPOINT_S_POS = 27,
};
...
enum SYSC_APP_CPU_REG_EMMC1_CTRL_FIELD {
    ...
    SYSC_APP_CPU_EMMC1_TX_CLK_DLY_CTL_DLY_STP_MASK = (int)0x7f,
    SYSC_APP_CPU_EMMC1_TX_CLK_DLY_CTL_DLY_STP_POS = 0,
    SYSC_APP_CPU_EMMC1_TX_CLK_DLY_CTL_DLY_VAL_ACTIVE_MASK = (int)0x80,
    SYSC_APP_CPU_EMMC1_TX_CLK_DLY_CTL_DLY_VAL_ACTIVE_POS = 7,
    SYSC_APP_CPU_EMMC1_TX_CLK_DLY_CTL_DLY_OUT_ACTIVE_MASK = (int)0x100,
    SYSC_APP_CPU_EMMC1_TX_CLK_DLY_CTL_DLY_OUT_ACTIVE_POS = 8,
    ...
    SYSC_APP_CPU_EMMC1_TX_CLK_SEL_TX_CLK_DELAY_MASK = (int)0x1000,
    SYSC_APP_CPU_EMMC1_TX_CLK_SEL_TX_CLK_DELAY_POS = 12,
    SYSC_APP_CPU_EMMC1_TX_CLK_SEL_SD_CLK_OUT_MASK = (int)0x2000,
    SYSC_APP_CPU_EMMC1_TX_CLK_SEL_SD_CLK_OUT_POS = 13,
    SYSC_APP_CPU_EMMC1_RX_CLK_SEL_MASK = (int)0xc000,
    SYSC_APP_CPU_EMMC1_RX_CLK_SEL_POS = 14,
    SYSC_APP_CPU_EMMC1_RX_CLK_SEL_S0_CCLK_RX_MASK = (int)0x4000,
    SYSC_APP_CPU_EMMC1_RX_CLK_SEL_S0_CCLK_RX_POS = 14,
    SYSC_APP_CPU_EMMC1_RX_CLK_SEL_S00_CCLK_RX_MASK = (int)0x8000,
    SYSC_APP_CPU_EMMC1_RX_CLK_SEL_S00_CCLK_RX_POS = 15,
    SYSC_APP_CPU_EMMC1_RX_CLK_DLY_CTL_MASK = (int)0x1ff0000,
    SYSC_APP_CPU_EMMC1_RX_CLK_DLY_CTL_POS = 16,
    SYSC_APP_CPU_EMMC1_RX_CLK_DLY_CTL_DLY_STP_MASK = (int)0x7f0000,
    SYSC_APP_CPU_EMMC1_RX_CLK_DLY_CTL_DLY_STP_POS = 16,
    SYSC_APP_CPU_EMMC1_RX_CLK_DLY_CTL_DLY_VAL_ACTIVE_MASK = (int)0x800000,
    SYSC_APP_CPU_EMMC1_RX_CLK_DLY_CTL_DLY_VAL_ACTIVE_POS = 23,
    SYSC_APP_CPU_EMMC1_RX_CLK_DLY_CTL_DLY_OUT_ACTIVE_MASK = (int)0x1000000,
    SYSC_APP_CPU_EMMC1_RX_CLK_DLY_CTL_DLY_OUT_ACTIVE_POS = 24,
    ...
    SYSC_APP_CPU_EMMC1_RX_DS_SEL_MASK = (int)0x78000000,
    SYSC_APP_CPU_EMMC1_RX_DS_SEL_POS = 27,
    SYSC_APP_CPU_EMMC1_RX_DS_SEL_CCLK_RX_BUF_MASK = (int)0x8000000,
    SYSC_APP_CPU_EMMC1_RX_DS_SEL_CCLK_RX_BUF_POS = 27,
    SYSC_APP_CPU_EMMC1_RX_DS_SEL_S01_CCLK_RX_MASK = (int)0x10000000,
    SYSC_APP_CPU_EMMC1_RX_DS_SEL_S01_CCLK_RX_POS = 28,
    SYSC_APP_CPU_EMMC1_RX_DS_SEL_TX_RX_CLK_MASK = (int)0x20000000,
    SYSC_APP_CPU_EMMC1_RX_DS_SEL_TX_RX_CLK_POS = 29,
    SYSC_APP_CPU_EMMC1_RX_DS_SEL_S10_CCLK_RX_MASK = (int)0x40000000,
    SYSC_APP_CPU_EMMC1_RX_DS_SEL_S10_CCLK_RX_POS = 30,
};

enum SYSC_APP_CPU_REG_EMMC2_DLL_CTRL_FIELD {
    SYSC_APP_CPU_EMMC2_DLL_CTRL_MASK = (int)0xffffff,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_POS = 0,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_DECODER_R_MASK = (int)0x7f,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_DECODER_R_POS = 0,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_DLL_CTRL_REG_INV_MASK = (int)0x80,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_DLL_CTRL_REG_INV_POS = 7,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_PHASE_DETECT_SEL_N_MASK = (int)0x700,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_PHASE_DETECT_SEL_N_POS = 8,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_PRE_CLK_GATE_CTL_MASK = (int)0x800,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_PRE_CLK_GATE_CTL_POS = 0,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_HALF_CLOCK_MODE_MASK = (int)0x2000,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_HALF_CLOCK_MODE_POS = 0,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_RD_MASK = (int)0xff000000,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_RD_POS = 24,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_RD_LOCK_MASK = (int)0x1000000,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_RD_LOCK_POS = 24,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_RD_PHASE1_MASK = (int)0x2000000,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_RD_PHASE1_POS = 25,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_RD_PHASE2_MASK = (int)0x4000000,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_RD_PHASE2_POS = 26,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_RD_SIGO_0_TESTPOINT_S_MASK = (int)0x8000000,
    SYSC_APP_CPU_EMMC2_DLL_CTRL_RD_SIGO_0_TESTPOINT_S_POS = 27,
};
