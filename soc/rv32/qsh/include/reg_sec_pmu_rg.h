...
enum SEC_PMU_RG_REG_TRIM0_FIELD
{
    ...
    SEC_PMU_RG_LDO_PECI_EN_MASK = (int)0x100000,
    SEC_PMU_RG_LDO_PECI_EN_POS = 20,
...
enum SEC_PMU_RG_REG_PMU_STATUS_FIELD
{
    ...
    SEC_PMU_RG_RST_SRC_BOR09_MASK = (int)0x1000000,
    SEC_PMU_RG_RST_SRC_BOR09_POS = 24,
    SEC_PMU_RG_RST_SRC_BOR33_MASK = (int)0x2000000,
    SEC_PMU_RG_RST_SRC_BOR33_POS = 25,
    SEC_PMU_RG_RST_SRC_PAD_MASK = (int)0x4000000,
    SEC_PMU_RG_RST_SRC_PAD_POS = 26,
    SEC_PMU_RG_RST_SRC_IWDT_MASK = (int)0x8000000,
    SEC_PMU_RG_RST_SRC_IWDT_POS = 27,
    SEC_PMU_RG_RST_SRC_SOFTWARE_MASK = (int)0x10000000,
    SEC_PMU_RG_RST_SRC_SOFTWARE_POS = 28,
    SEC_PMU_RG_RST_SRC_CPU_MASK = (int)0x20000000,
    SEC_PMU_RG_RST_SRC_CPU_POS = 29,
    SEC_PMU_RG_RST_SRC_POR_MASK = (int)0x40000000,
    SEC_PMU_RG_RST_SRC_POR_POS = 30,
};
