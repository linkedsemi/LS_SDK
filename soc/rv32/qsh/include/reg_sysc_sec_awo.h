...
enum SYSC_SEC_AWO_REG_DPLL1_CTRL1_FIELD {
    ...
    SYSC_SEC_AWO_DPLL1_CTRL1_PLL1_EN_MASK = (int)0x1,
    SYSC_SEC_AWO_DPLL1_CTRL1_PLL1_EN_POS = 0,
    SYSC_SEC_AWO_DPLL1_CTRL1_PLL1_RSTN_MASK = (int)0x2,
    SYSC_SEC_AWO_DPLL1_CTRL1_PLL1_RSTN_POS = 1,
    SYSC_SEC_AWO_DPLL1_CTRL1_PLL1_CLKREF_SEL_MASK = (int)0xc,
    SYSC_SEC_AWO_DPLL1_CTRL1_PLL1_CLKREF_SEL_POS = 2,
};
...
enum SYSC_SEC_AWO_REG_DPLL2_CTRL1_FIELD {
    ...
    SYSC_SEC_AWO_DPLL2_CTRL1_PLL2_EN_MASK = (int)0x1,
    SYSC_SEC_AWO_DPLL2_CTRL1_PLL2_EN_POS = 0,
    SYSC_SEC_AWO_DPLL2_CTRL1_PLL2_RSTN_MASK = (int)0x2,
    SYSC_SEC_AWO_DPLL2_CTRL1_PLL2_RSTN_POS = 1,
    SYSC_SEC_AWO_DPLL2_CTRL1_PLL2_CLKREF_SEL_MASK = (int)0xc,
    SYSC_SEC_AWO_DPLL2_CTRL1_PLL2_CLKREF_SEL_POS = 2,
};
...
enum SYSC_SEC_AWO_REG_PD_AWO_ANA1_FIELD {
    SYSC_SEC_AWO_OSSCRC_CAL_MASK = (int)0x7ff,
    SYSC_SEC_AWO_OSSCRC_CAL_POS = 0,
    SYSC_SEC_AWO_OSSCRC_CAP_MASK = (int)0xc00,
    SYSC_SEC_AWO_OSSCRC_CAP_POS = 10,
};
