...
typedef struct
{
    ...
    volatile uint32_t TPM_SPIS_TX_ALERT; //0xf8
    volatile uint32_t TPM_SPIS_RX_ALERT; //0xfc
} reg_sysc_sec_cpu_t;
...
enum SYSC_SEC_CPU_REG_SYS_CLK_FIELD {
    ...
    SYSC_SEC_CPU_DBG_EN_MASK = (int)0x10,
    SYSC_SEC_CPU_DBG_EN_POS = 4,
};
...
enum SYSC_SEC_CPU_REG_PD_CPU_CLKG1_FIELD {
    ...
    SYSC_SEC_CPU_CLKG_SET_TPM_SPIS1_MASK = (int)0x4000,
    SYSC_SEC_CPU_CLKG_SET_TPM_SPIS1_POS = 14,
    SYSC_SEC_CPU_CLKG_CLR_TPM_SPIS1_MASK = (int)0x8000,
    SYSC_SEC_CPU_CLKG_CLR_TPM_SPIS1_POS = 15,
    SYSC_SEC_CPU_CLKG_SET_TPM_SPIS2_MASK = (int)0x10000,
    SYSC_SEC_CPU_CLKG_SET_TPM_SPIS2_POS = 16,
    SYSC_SEC_CPU_CLKG_CLR_TPM_SPIS2_MASK = (int)0x20000,
    SYSC_SEC_CPU_CLKG_CLR_TPM_SPIS2_POS = 17,
...
enum SYSC_SEC_CPU_REG_PD_CPU_SRST1_FIELD {
    ...
    SYSC_SEC_CPU_SRST_SET_TPM_SPIS1_MASK = (int)0x4000,
    SYSC_SEC_CPU_SRST_SET_TPM_SPIS1_POS = 14,
    SYSC_SEC_CPU_SRST_CLR_TPM_SPIS1_MASK = (int)0x8000,
    SYSC_SEC_CPU_SRST_CLR_TPM_SPIS1_POS = 15,
    SYSC_SEC_CPU_SRST_SET_TPM_SPIS2_MASK = (int)0x10000,
    SYSC_SEC_CPU_SRST_SET_TPM_SPIS2_POS = 16,
    SYSC_SEC_CPU_SRST_CLR_TPM_SPIS2_MASK = (int)0x20000,
    SYSC_SEC_CPU_SRST_CLR_TPM_SPIS2_POS = 17,
...
enum SYSC_SEC_CPU_REG_INTR_CTRL_INTR_MSK_FIELD {
    ...
    SYSC_SEC_CPU_TPM_SPIS1_INTR_MSK_MASK = (int)0x30000,
    SYSC_SEC_CPU_TPM_SPIS1_INTR_MSK_POS = 16,
    SYSC_SEC_CPU_TPM_SPIS2_INTR_MSK_MASK = (int)0x300000,
    SYSC_SEC_CPU_TPM_SPIS2_INTR_MSK_POS = 20,
};

enum SYSC_SEC_CPU_REG_INTR_CLR_MSK_FIELD {
    SYSC_SEC_CPU_OTBN_INTR_CLR_MASK = (int)0x7ff,
    SYSC_SEC_CPU_OTBN_INTR_CLR_POS = 0,
    SYSC_SEC_CPU_TPM_SPIS1_INTR_CLR_MASK = (int)0x30000,
    SYSC_SEC_CPU_TPM_SPIS1_INTR_CLR_POS = 16,
    SYSC_SEC_CPU_TPM_SPIS2_INTR_CLR_MASK = (int)0x300000,
    SYSC_SEC_CPU_TPM_SPIS2_INTR_CLR_POS = 20,
};

enum SYSC_SEC_CPU_REG_OTBN_INTR_STT_FIELD {
    SYSC_SEC_CPU_OTBN_INTR_STT_MASK = (int)0x7ff,
    SYSC_SEC_CPU_OTBN_INTR_STT_POS = 0,
    SYSC_SEC_CPU_TPM_SPIS1_INTR_STT_MASK = (int)0x30000,
    SYSC_SEC_CPU_TPM_SPIS1_INTR_STT_POS = 16,
    SYSC_SEC_CPU_TPM_SPIS2_INTR_STT_MASK = (int)0x300000,
    SYSC_SEC_CPU_TPM_SPIS2_INTR_STT_POS = 20,
};

enum SYSC_SEC_CPU_REG_OTBN_INTR_RAW_FIELD {
    SYSC_SEC_CPU_OTBN_INTR_RAW_MASK = (int)0x7ff,
    SYSC_SEC_CPU_OTBN_INTR_RAW_POS = 0,
    SYSC_SEC_CPU_TPM_SPIS1_INTR_RAW_MASK = (int)0x30000,
    SYSC_SEC_CPU_TPM_SPIS1_INTR_RAW_POS = 16,
    SYSC_SEC_CPU_TPM_SPIS_INTR2_RAW_MASK = (int)0x300000,
    SYSC_SEC_CPU_TPM_SPIS_INTR2_RAW_POS = 20,
};
...
enum SYSC_SEC_CPU_REG_TPM_SPIS_TX_ALERT_FIELD {
    SYSC_SEC_CPU_TPM_SPIS1_ALERT_TX0_ALERT_P_MASK = (int)0x1,
    SYSC_SEC_CPU_TPM_SPIS1_ALERT_TX0_ALERT_P_POS = 0,
    SYSC_SEC_CPU_TPM_SPIS1_ALERT_TX0_ALERT_N_MASK = (int)0x2,
    SYSC_SEC_CPU_TPM_SPIS1_ALERT_TX0_ALERT_N_POS = 1,
    SYSC_SEC_CPU_TPM_SPIS2_ALERT_TX0_ALERT_P_MASK = (int)0x10,
    SYSC_SEC_CPU_TPM_SPIS2_ALERT_TX0_ALERT_P_POS = 4,
    SYSC_SEC_CPU_TPM_SPIS2_ALERT_TX0_ALERT_N_MASK = (int)0x20,
    SYSC_SEC_CPU_TPM_SPIS2_ALERT_TX0_ALERT_N_POS = 5,
};

enum SYSC_SEC_CPU_REG_TPM_SPIS_RX_ALERT_FIELD {
    SYSC_SEC_CPU_TPM_SPIS1_ALERT_RX0_PING_P_MASK = (int)0x1,
    SYSC_SEC_CPU_TPM_SPIS1_ALERT_RX0_PING_P_POS = 0,
    SYSC_SEC_CPU_TPM_SPIS1_ALERT_RX0_PING_N_MASK = (int)0x2,
    SYSC_SEC_CPU_TPM_SPIS1_ALERT_RX0_PING_N_POS = 1,
    SYSC_SEC_CPU_TPM_SPIS1_ALERT_RX0_ACK_P_MASK = (int)0x4,
    SYSC_SEC_CPU_TPM_SPIS1_ALERT_RX0_ACK_P_POS = 2,
    SYSC_SEC_CPU_TPM_SPIS1_ALERT_RX0_ACK_N_MASK = (int)0x8,
    SYSC_SEC_CPU_TPM_SPIS1_ALERT_RX0_ACK_N_POS = 3,
    SYSC_SEC_CPU_TPM_SPIS2_ALERT_RX0_PING_P_MASK = (int)0x100,
    SYSC_SEC_CPU_TPM_SPIS2_ALERT_RX0_PING_P_POS = 8,
    SYSC_SEC_CPU_TPM_SPIS2_ALERT_RX0_PING_N_MASK = (int)0x200,
    SYSC_SEC_CPU_TPM_SPIS2_ALERT_RX0_PING_N_POS = 9,
    SYSC_SEC_CPU_TPM_SPIS2_ALERT_RX0_ACK_P_MASK = (int)0x400,
    SYSC_SEC_CPU_TPM_SPIS2_ALERT_RX0_ACK_P_POS = 10,
    SYSC_SEC_CPU_TPM_SPIS2_ALERT_RX0_ACK_N_MASK = (int)0x800,
    SYSC_SEC_CPU_TPM_SPIS2_ALERT_RX0_ACK_N_POS = 11,
    SYSC_SEC_CPU_TPM_SPIS1_MODE_MASK = (int)0x70000,
    SYSC_SEC_CPU_TPM_SPIS1_MODE_POS = 16,
