...
{
    SYSC_PER_CLKG_SET_ADC0_MASK = (int)0x100,
    SYSC_PER_CLKG_SET_ADC0_POS = 8,
    SYSC_PER_CLKG_CLR_ADC0_MASK = (int)0x200,
    SYSC_PER_CLKG_CLR_ADC0_POS = 9,
    SYSC_PER_CLKG_SET_ADC1_MASK = (int)0x400,
    SYSC_PER_CLKG_SET_ADC1_POS = 10,
    SYSC_PER_CLKG_CLR_ADC1_MASK = (int)0x800,
    SYSC_PER_CLKG_CLR_ADC1_POS = 11,
