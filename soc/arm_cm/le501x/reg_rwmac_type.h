...
enum RWMAC_REG_INTCNTL1_FIELD
{
    ...
    RWMAC_FIFOINT_MASK = (int)0x8000,
    RWMAC_FIFOINT_POS = 15,
    RWMAC_TIMESTAMPTGT2INT_MASK = (int)0x40,
    RWMAC_TIMESTAMPTGT2INT_POS = 6,
    RWMAC_TIMESTAMPTGT1INT_MASK = (int)0x20,
    RWMAC_TIMESTAMPTGT1INT_POS = 5,
    RWMAC_FINETGTINT_MASK = (int)0x10,
    RWMAC_FINETGTINT_POS = 4,
    RWMAC_SWINT_MASK = (int)0x8,
    RWMAC_SWINT_POS = 3,
    RWMAC_CRYPTINT_MASK = (int)0x4,
    RWMAC_CRYPTINT_POS = 2,
    RWMAC_SLPINT_MASK = (int)0x2,
    RWMAC_SLPINT_POS = 1,
    RWMAC_CLKNINT_MASK = (int)0x1,
    RWMAC_CLKNINT_POS = 0,
};
