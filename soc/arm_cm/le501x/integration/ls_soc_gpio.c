...
static gpio_port_pin_t uart1_ck;
...
static gpio_port_pin_t i2c1_scl;
static gpio_port_pin_t i2c1_sda;
static gpio_port_pin_t i2c2_scl;
static gpio_port_pin_t i2c2_sda;
...
void gpio_af_init(gpio_port_pin_t *pin,enum GPIO_AF af)
{
...
static void gpio_ana_init(gpio_port_pin_t *pin,enum GPIO_ANA_FUNC ana)
{
   reg_lsgpio_t *port = GPIO_GetPort(pin->port);
...
void pinmux_spi2_master_clk_init(uint8_t clk, uint8_t cpol)
{
    *(uint8_t *)&spi2_clk = clk;
    ...
    gpio_af_init((gpio_port_pin_t *)&clk,AF_SPI2_SCK);
}
...
void pinmux_spi2_master_nss_init(uint8_t nss)
{
    *(uint8_t *)&spi2_nss = nss;
    ...
    gpio_af_init((gpio_port_pin_t *)&nss,AF_SPI2_NSS);    
}
...
void pinmux_spi2_master_mosi_init(uint8_t mosi)
{
    *(uint8_t *)&spi2_mosi = mosi;
    ...
    gpio_af_init((gpio_port_pin_t *)&mosi,AF_SPI2_MOSI);
}
...
void pinmux_spi2_master_miso_init(uint8_t miso)
{
    *(uint8_t *)&spi2_miso = miso;
    ...
    gpio_af_init((gpio_port_pin_t *)&miso,AF_SPI2_MISO); 
}
...
void pinmux_iis2_master_ck_init(uint8_t ck)
{
    *(uint8_t *)&i2s2_ck = ck;
    ...
    gpio_af_init((gpio_port_pin_t *)&ck,AF_SPI2_SCK);
}
...
void pinmux_iis2_master_ws_init(uint8_t ws)
{
    *(uint8_t *)&i2s2_ws = ws;
    ...
    gpio_af_init((gpio_port_pin_t *)&ws,AF_SPI2_NSS);    
}
...
void pinmux_iis2_master_sd_init(uint8_t sd, uint8_t mode)
{
    *(uint8_t *)&i2s2_sd = sd;
    ...
    gpio_af_init((gpio_port_pin_t *)&sd,AF_SPI2_MOSI);
}
...
void pinmux_ssi_clk_init(uint8_t clk, uint8_t cpol)
{
    *(uint8_t *)&ssi_clk = clk;
    spi_master_clk_io_cfg(clk,cpol);
    gpio_af_init((gpio_port_pin_t *)&clk,AF_SPI1_SCK);
}
...
void pinmux_ssi_nss0_init(uint8_t nss0)
{
    *(uint8_t *)&ssi_nss0 = nss0;
    ...
    gpio_af_init((gpio_port_pin_t *)&nss0,AF_SPI1_NSS0);
}
...
void pinmux_ssi_nss1_init(uint8_t nss1)
{
    *(uint8_t *)&ssi_nss1 = nss1;
    ...
    gpio_af_init((gpio_port_pin_t *)&nss1,AF_SPI1_NSS0);    
}
...
void pinmux_ssi_dq0_init(uint8_t dq0)
{
    *(uint8_t *)&ssi_dq0 = dq0;
    ...
    gpio_af_init((gpio_port_pin_t *)&dq0,AF_SPI1_DQ0);
}
...
void pinmux_ssi_dq1_init(uint8_t dq1)
{
    *(uint8_t *)&ssi_dq1 = dq1;
    ...
    gpio_af_init((gpio_port_pin_t *)&dq1,AF_SPI1_DQ1); 
}
...
void pinmux_ssi_dq2_init(uint8_t dq2)
{
    *(uint8_t *)&ssi_dq2 = dq2;
    ...
    gpio_af_init((gpio_port_pin_t *)&dq2,AF_SPI1_DQ2); 
}
...
void pinmux_ssi_dq3_init(uint8_t dq3)
{
    *(uint8_t *)&ssi_dq3 = dq3;
    ...
    gpio_af_init((gpio_port_pin_t *)&dq3,AF_SPI1_DQ3); 
}
...
void pinmux_uart1_init(uint8_t txd,uint8_t rxd)
{
    ...
    *(uint8_t *)&uart1_rxd = rxd;
    uart_io_cfg(txd,rxd);
    gpio_af_init((gpio_port_pin_t *)&txd,AF_UART1_TXD);
    gpio_af_init((gpio_port_pin_t *)&rxd,AF_UART1_RXD);
}

void pinmux_uart1_deinit()
{
    set_gpio_mode((gpio_port_pin_t *)&uart1_txd);
    set_gpio_mode((gpio_port_pin_t *)&uart1_rxd);
}
...
void pinmux_uart2_init(uint8_t txd,uint8_t rxd)
{
    ...
    *(uint8_t *)&uart2_rxd = rxd;
    uart_io_cfg(txd,rxd);
    gpio_af_init((gpio_port_pin_t *)&txd,AF_UART2_TXD);
    gpio_af_init((gpio_port_pin_t *)&rxd,AF_UART2_RXD);
}

void pinmux_uart2_deinit()
{
    set_gpio_mode((gpio_port_pin_t *)&uart2_txd);
    set_gpio_mode((gpio_port_pin_t *)&uart2_rxd);
}
...
void pinmux_uart3_init(uint8_t txd,uint8_t rxd)
{
    ...
    *(uint8_t *)&uart3_rxd = rxd;
    uart_io_cfg(txd,rxd);
    gpio_af_init((gpio_port_pin_t *)&txd,AF_UART3_TXD);
    gpio_af_init((gpio_port_pin_t *)&rxd,AF_UART3_RXD);
}

void pinmux_uart3_deinit()
{
    set_gpio_mode((gpio_port_pin_t *)&uart3_txd);
    set_gpio_mode((gpio_port_pin_t *)&uart3_rxd);
}

void pinmux_uart1_7816_deinit()
{
    set_gpio_mode((gpio_port_pin_t *)&uart1_txd);
    set_gpio_mode((gpio_port_pin_t *)&uart1_ck);
}
...
void pinmux_iic1_init(uint8_t scl,uint8_t sda)
{
    ...
    *(uint8_t *)&i2c1_sda = sda;
    i2c_io_cfg( scl, sda);
    gpio_af_init((gpio_port_pin_t *)&scl,AF_I2C1_SCL);
    gpio_af_init((gpio_port_pin_t *)&sda,AF_I2C1_SDA);    
}
void pinmux_iic1_deinit()
{
    set_gpio_mode((gpio_port_pin_t *)&i2c1_scl);
    set_gpio_mode((gpio_port_pin_t *)&i2c1_sda);
}
void pinmux_iic2_init(uint8_t scl,uint8_t sda)
{
    ...
    *(uint8_t *)&i2c2_sda = sda;
    i2c_io_cfg( scl, sda);
    gpio_af_init((gpio_port_pin_t *)&scl,AF_I2C2_SCL);
    gpio_af_init((gpio_port_pin_t *)&sda,AF_I2C2_SDA);    
}
void pinmux_iic2_deinit()
{
    set_gpio_mode((gpio_port_pin_t *)&i2c2_scl);
    set_gpio_mode((gpio_port_pin_t *)&i2c2_sda);
}
...
void pinmux_uart1_7816_init(uint8_t txd,uint8_t ck)
{
    ...
    *(uint8_t *)&uart1_ck = ck;
    ...
    gpio_af_init((gpio_port_pin_t *)&txd,AF_UART1_TXD);
    gpio_af_init((gpio_port_pin_t *)&ck,AF_UART1_CK);
}
...
void pinmux_adtim1_ch1_init(uint8_t pin,bool output,uint8_t default_val)
{
    *(uint8_t *)&adtim1_ch1 = pin;
    ...
    gpio_af_init((gpio_port_pin_t *)&pin,AF_ADTIM1_CH1);
}
...
void pinmux_adtim1_ch2_init(uint8_t pin,bool output,uint8_t default_val)
{
    *(uint8_t *)&adtim1_ch2 = pin;
    timer_ch_io_cfg(pin,output,default_val);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_ADTIM1_CH2);
}
...
void pinmux_adtim1_ch3_init(uint8_t pin,bool output,uint8_t default_val)
{
    *(uint8_t *)&adtim1_ch3 = pin;
    timer_ch_io_cfg(pin,output,default_val);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_ADTIM1_CH3);
}
...
void pinmux_adtim1_ch4_init(uint8_t pin,bool output,uint8_t default_val)
{
    *(uint8_t *)&adtim1_ch4 = pin;
    timer_ch_io_cfg(pin,output,default_val);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_ADTIM1_CH4);
}
...
void pinmux_adtim1_ch1n_init(uint8_t pin)
{
    *(uint8_t *)&adtim1_ch1n = pin;
    ...
    gpio_af_init((gpio_port_pin_t *)&pin,AF_ADTIM1_CH1N);
}
...
void pinmux_adtim1_ch2n_init(uint8_t pin)
{
    *(uint8_t *)&adtim1_ch2n = pin;
    ...
    gpio_af_init((gpio_port_pin_t *)&pin,AF_ADTIM1_CH2N);
}
...
void pinmux_adtim1_ch3n_init(uint8_t pin)
{
    *(uint8_t *)&adtim1_ch3n = pin;
    ...
    gpio_af_init((gpio_port_pin_t *)&pin,AF_ADTIM1_CH3N);
}
...
void pinmux_adtim1_etr_init(uint8_t pin)
{
    *(uint8_t *)&adtim1_etr = pin;
    io_cfg_input(pin);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_ADTIM1_ETR);
}
...
void pinmux_adtim1_bk_init(uint8_t pin)
{
    *(uint8_t *)&adtim1_bk = pin;
    io_cfg_input(pin);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_ADTIM1_BK);
}
...
void pinmux_gptima1_ch1_init(uint8_t pin,bool output,uint8_t default_val)
{
    *(uint8_t *)&gptima1_ch1 = pin;
    timer_ch_io_cfg(pin,output,default_val);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_GPTIMA1_CH1);
}
...
void pinmux_gptima1_ch2_init(uint8_t pin,bool output,uint8_t default_val)
{
    *(uint8_t *)&gptima1_ch2 = pin;
    timer_ch_io_cfg(pin,output,default_val);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_GPTIMA1_CH2);
}
...
void pinmux_gptima1_ch3_init(uint8_t pin,bool output,uint8_t default_val)
{
    *(uint8_t *)&gptima1_ch3 = pin;
    timer_ch_io_cfg(pin,output,default_val);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_GPTIMA1_CH3);
}
...
void pinmux_gptima1_ch4_init(uint8_t pin,bool output,uint8_t default_val)
{
    *(uint8_t *)&gptima1_ch4 = pin;
    timer_ch_io_cfg(pin,output,default_val);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_GPTIMA1_CH4);
}
...
void pinmux_gptima1_etr_init(uint8_t pin)
{
    *(uint8_t *)&gptima1_etr = pin;
    io_cfg_input(pin);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_GPTIMA1_ETR);
}
...
void pinmux_gptimb1_ch1_init(uint8_t pin,bool output,uint8_t default_val)
{
    *(uint8_t *)&gptimb1_ch1 = pin;
    timer_ch_io_cfg(pin,output,default_val);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_GPTIMB1_CH1);
}
...
void pinmux_gptimb1_ch2_init(uint8_t pin,bool output,uint8_t default_val)
{
    *(uint8_t *)&gptimb1_ch2 = pin;
    timer_ch_io_cfg(pin,output,default_val);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_GPTIMB1_CH2);
}
...
void pinmux_gptimb1_ch3_init(uint8_t pin,bool output,uint8_t default_val)
{
    *(uint8_t *)&gptimb1_ch3 = pin;
    timer_ch_io_cfg(pin,output,default_val);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_GPTIMB1_CH3);
}
...
void pinmux_gptimb1_ch4_init(uint8_t pin,bool output,uint8_t default_val)
{
    *(uint8_t *)&gptimb1_ch4 = pin;
    timer_ch_io_cfg(pin,output,default_val);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_GPTIMB1_CH4);
}
...
void pinmux_gptimb1_etr_init(uint8_t pin)
{
    *(uint8_t *)&gptimb1_etr = pin;
    io_cfg_input(pin);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_GPTIMB1_ETR);
}
...
void pinmux_gptimc1_ch1_init(uint8_t pin,bool output,uint8_t default_val)
{
    *(uint8_t *)&gptimc1_ch1 = pin;
    timer_ch_io_cfg(pin,output,default_val);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_GPTIMC1_CH1);
}
...
void pinmux_gptimc1_ch1n_init(uint8_t pin)
{
    *(uint8_t *)&gptimc1_ch1n = pin;
    ...
    gpio_af_init((gpio_port_pin_t *)&pin,AF_GPTIMC1_CH1N);
}
...
void pinmux_gptimc1_ch2_init(uint8_t pin,bool output,uint8_t default_val)
{
    *(uint8_t *)&gptimc1_ch2 = pin;
    timer_ch_io_cfg(pin,output,default_val);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_GPTIMC1_CH2);
}
...
void pinmux_gptimc1_bk_init(uint8_t pin)
{
    *(uint8_t *)&gptimc1_bk = pin;
    io_cfg_input(pin);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_GPTIMC1_BK);
}
...
{
    gpio_ana_init((gpio_port_pin_t *)&ain,ANA_FUNC1);
}

void gpio_ana_deinit(uint8_t ain)
{
    set_gpio_mode((gpio_port_pin_t *)&ain);
    io_cfg_disable(ain);
}
...
void pinmux_pdm_clk_init(uint8_t pin)
{
    *(uint8_t *)&pdm_clk = pin;
    io_cfg_output(pin);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_PDM_CLK);
}
...
void pinmux_pdm_data0_init(uint8_t pin)
{
    *(uint8_t *)&pdm_data0 = pin;
    io_cfg_input(pin);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_PDM_DATA0);
}
...
void pinmux_pdm_data1_init(uint8_t pin)
{
    *(uint8_t *)&pdm_data1 = pin;
    io_cfg_input(pin);
    gpio_af_init((gpio_port_pin_t *)&pin,AF_PDM_DATA1);
}
