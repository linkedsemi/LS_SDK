...
SVCALL(SVCALL_FLASH_PROGRAM,void,do_hal_flash_program_svcall(void *param));
SVCALL(SVCALL_FLASH_ERASE,void, do_hal_flash_erase_svcall(void *param));
...
SVCALL(SVCALL_FLASH_PROGRAM_SECURITY,void,do_hal_flash_program_security_area_svcall(void *param));
SVCALL(SVCALL_FLASH_READ_SECURITY,void,do_hal_flash_read_security_area_svcall(void *param));
