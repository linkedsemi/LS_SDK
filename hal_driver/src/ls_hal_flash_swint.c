...
#ifndef __CC_ARM
NOINLINE void do_hal_flashx_program_swint(struct hal_flash_env *env,void *param)
{
    SWINT_FUNC_CALL_INLINE_ASM(do_hal_flashx_program,FLASH_SWINT_NUM);
}

NOINLINE void do_hal_flashx_write_reg_swint(struct hal_flash_env *env,void *param)
{
    SWINT_FUNC_CALL_INLINE_ASM(do_hal_flashx_write_reg,FLASH_SWINT_NUM);
}

NOINLINE void do_hal_flashx_read_swint(struct hal_flash_env *env,void *param)
{
    SWINT_FUNC_CALL_INLINE_ASM(do_hal_flashx_read,FLASH_SWINT_NUM);
}

NOINLINE void do_hal_flashx_read_reg_swint(struct hal_flash_env *env,void *param)
{
    SWINT_FUNC_CALL_INLINE_ASM(do_hal_flashx_read_reg,FLASH_SWINT_NUM);
}

NOINLINE void do_hal_flashx_chip_erase_swint(struct hal_flash_env *env,void *param)
{
