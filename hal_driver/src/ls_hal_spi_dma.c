...
static void spi_dma_config(SPI_HandleTypeDef *hspi,void *TX_Data,void *RX_Data,uint16_t Count)
{
    ...
    cfg.dummy = 0;
    HAL_DMA_Channel_Start_IT(hspi->DMAC_Instance,hspi->DMATx.DMA_Channel,&cfg,SPI_Transmit_DMA_Callback,(uint32_t)hspi);
    ...
    HAL_DMA_Channel_Start_IT(hspi->DMAC_Instance,hspi->DMARx.DMA_Channel,&cfg,SPI_Receive_DMA_Callback,(uint32_t)hspi);
