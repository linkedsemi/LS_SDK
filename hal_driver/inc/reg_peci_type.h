...
enum PECI_REG_INTR_MSK_FIELD
{
    ...
    PECI_INTR_MSK_POS = 0,
    PECI_INTR_32BYTES_END_MSK_MASK = (int)0x2,
    PECI_INTR_32BYTES_END_MSK_POS = 1,
};
...
enum PECI_REG_INTR_CLR_FIELD
{
    ...
    PECI_INTR_CLR_POS = 0,
    PECI_INTR_32BYTES_END_CLR_MASK = (int)0x2,
    PECI_INTR_32BYTES_END_CLR_POS = 1,
};
...
enum PECI_REG_PECI_CTRL_FIELD
{
    ...
    PECI_WT_MODE_MASK = (int)0x80000000,
    PECI_WT_MODE_POS = 31,
};
