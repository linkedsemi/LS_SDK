...
#ifdef FLASH_API_ALL_IN_RAM
#define FLASH_API_SECTION(__NAME,...) XIP_BANNED_FUNC(__NAME,__VA_ARGS__)
#else
#define FLASH_API_SECTION(__NAME,...) __NAME(__VA_ARGS__)
#endif

#define WRITE_STATUS_REGISTER_OPCODE 0x01
#define WRITE_STATUS_REGISTER_0_OPCODE 0x01
...
#define SECTOR_ERASE4B_OPCODE 0x21
#define CHIP_ERASE_OPCODE 0x60
#define BLOCK_32K_ERASE_OPCODE 0x52
#define BLOCK_32K_ERASE4B_OPCODE 0x5c
#define BLOCK_64K_ERASE_OPCODE 0xd8
#define BLOCK_64K_ERASE4B_OPCODE 0xdc
