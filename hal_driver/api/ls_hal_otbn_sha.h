 ...
 * wrapper layer below):
 *   ls_otbn_status_t  LS_OTBN_OK on success, non-zero on failure.
 *   No function here returns a boolean; results are written to
 *   the out parameter only.
 * ============================================================ */
...
ls_otbn_status_t HAL_OTBN_SHA256_Final(uint8_t result[SHA256_RESULT_SIZE]);
