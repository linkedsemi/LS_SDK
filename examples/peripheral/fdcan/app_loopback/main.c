...
#define FDCAN_TRX_DATA_LEN   12
#define FDCAN_CONFIG_DLC     FDCAN_DLC_BYTES_12
...
uint8_t TxData0[FDCAN_TRX_DATA_LEN] = {0};

bool tx_cmpflag = true;

static void FDCAN_Mode_Config(void)
{
    pTxMsg.TxData = TxData0;
    ...
    FDCan_Handle.Init.Mode = FDCAN_MODE_LOOPBACK;
...
int main(void)
{
    ...
    HAL_FDCAN_Receive_IT(&FDCan_Handle);
    memset(TxData0,0x3C,sizeof(TxData0));
