...
__attribute__((aligned(2))) uint8_t TxBuffer[] = {0x0A,0x33,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0a,0x0b,0x0c,0x0d,0x0e,0xf};
...
int main()
{
    ...
    // status = HAL_SPIS_Receive(&SPIS_Hdl, (uint8_t*)RxBuffer, BUFFERSIZE, 10000);  //当cap_infnt等于1时，Size必须和cap_idx相等
    // status = HAL_SPIS_Transmit(&SPIS_Hdl,(uint8_t*)TxBuffer, BUFFERSIZE, 10000);
    status= HAL_SPIS_TransmitReceive(&SPIS_Hdl, (uint8_t*)TxBuffer, (uint8_t*)RxBuffer, BUFFERSIZE, 10000);
