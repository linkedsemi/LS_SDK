...
/**buff**/
uint8_t ciphertext_buff[64]= {0};
uint8_t plaintext_buff[64] = {0};
...
void crypt_cbc_ecb_test_128(void)
{
    ...
    /*CRYPT_AES_ECB_TEST*/
    HAL_AES_ECB_Crypt_Blocks(ENCRYPT, cbc_ecb_plaintext, sizeof(cbc_ecb_plaintext), ciphertext_buff);
    ...
    HAL_AES_ECB_Crypt_Blocks(DECRYPT, ecb_ciphertext_128, sizeof(ecb_ciphertext_128), plaintext_buff);
    ...
    /*CRYPT_AES_CBC_TEST*/
    HAL_AES_CBC_Crypt_Blocks(ENCRYPT, cbc_iv, cbc_ecb_plaintext, sizeof(cbc_ecb_plaintext), ciphertext_buff);
    ...
    HAL_AES_CBC_Crypt_Blocks(DECRYPT, cbc_iv, cbc_ciphertext_128, sizeof(cbc_ciphertext_128), plaintext_buff);
...
void crypt_cbc_ecb_test_192(void)
{
    ...
    HAL_AES_ECB_Crypt_Blocks(DECRYPT, ecb_ciphertext_192, sizeof(ecb_ciphertext_192), plaintext_buff);
    ...
    HAL_AES_CBC_Crypt_Blocks(DECRYPT, cbc_iv, cbc_ciphertext_192, sizeof(cbc_ciphertext_192), plaintext_buff);
...
void crypt_cbc_ecb_test_256(void)
{
    ...
    HAL_AES_ECB_Crypt_Blocks(DECRYPT, ecb_ciphertext_256, sizeof(ecb_ciphertext_256), plaintext_buff);
    ...
    HAL_AES_CBC_Crypt_Blocks(DECRYPT, cbc_iv, cbc_ciphertext_256, sizeof(cbc_ciphertext_256), plaintext_buff);
