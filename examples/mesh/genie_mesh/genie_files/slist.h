 ...
 */
#define SYS_SLIST_CONTAINER(__ln, type, __n) \
 ...
 * @param __n The field name of sys_node_t within the container struct
 */
#define SYS_SLIST_PEEK_HEAD_CONTAINER(__sl, type, __n) \
	SYS_SLIST_CONTAINER(sys_slist_peek_head(__sl), type, __n)
 ...
 * @param __n The field name of sys_node_t within the container struct
 */
#define SYS_SLIST_PEEK_TAIL_CONTAINER(__sl, type, __n) \
	SYS_SLIST_CONTAINER(sys_slist_peek_tail(__sl), type, __n)
...
#define SYS_SLIST_FOR_EACH_CONTAINER(__sl, type, __cn, __n)			\
	for (__cn = SYS_SLIST_PEEK_HEAD_CONTAINER(__sl, type, __n); __cn; \
	     __cn = SYS_SLIST_PEEK_NEXT_CONTAINER(__cn, type, __n))
 ...
 * @param __n The field name of sys_node_t within the container struct
 */
#define SYS_SLIST_FOR_EACH_CONTAINER_SAFE(__sl, type, __cn, __cns, __n)	\
	for (__cn = SYS_SLIST_PEEK_HEAD_CONTAINER(__sl, type, __n),	\
	     __cns = SYS_SLIST_PEEK_NEXT_CONTAINER(__cn, type,__n); __cn;	\
	     __cn = __cns, __cns = SYS_SLIST_PEEK_NEXT_CONTAINER(__cn, type, __n))
