...
#define RECORD_SIGMESH_ELEMENT0_INFO  3
#define RECORD_SIGMESH_ELEMENT1_INFO  4
#define RECORD_SIGMESH_ELEMENT2_INFO  5
#define RECORD_SIGMESH_ELEMENT3_INFO  6
#define REG_MODEL_SVC_NUM  (MODEL2_VENDOR_MODEL_SVC+1)
...
void app_vendor_model_tx_message_handler(uint8_t *data, uint8_t data_len);
